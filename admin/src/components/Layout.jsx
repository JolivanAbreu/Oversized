    ...
    <div className="flex min-h-screen">
      <aside className="flex w-60 shrink-0 flex-col bg-ink px-4 py-6">
        ...
        <div className="border-t border-white/10 pt-4">
          <p className="px-2 text-xs text-white/60">{user?.name}</p>
          <p className="px-2 text-[11px] uppercase tracking-widest text-white/30">{user?.role === 'admin' ? 'Administrador' : 'Operador'}</p>
