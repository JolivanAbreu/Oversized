...
const REFRESH_KEY = 'bos_refresh_token';
...
/**
 * Wrapper de fetch com base URL, header de autenticação automático e uma
 * tentativa de refresh transparente quando o access token expira (401).
 */
